// app/Views/partials/import_index_scripts.php
...
$(document).ready(function() {
    ...
    // Inicializa el estado del enlace de descarga al cargar la página.
    updateDownloadLink();

    // Actualiza el enlace cuando el tipo de activo en el select cambia.
