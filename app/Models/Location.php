...
class Location
{
    ...
    {
        try {
            $stmt = $this->db->query("SELECT id, nombre, descripcion FROM ubicaciones ORDER BY nombre ASC");
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT id, nombre, descripcion FROM ubicaciones WHERE nombre = :nombre");
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT id, nombre, descripcion FROM ubicaciones WHERE id = :id");
    ...
    {
        try {
            $stmt = $this->db->prepare("INSERT INTO ubicaciones (nombre, descripcion) VALUES (:nombre, :descripcion)");
    ...
    {
        try {
            $stmt = $this->db->prepare("UPDATE ubicaciones SET nombre = :nombre, descripcion = :descripcion WHERE id = :id");
            $stmt->bindParam(':nombre', $nombre, PDO::PARAM_STR);
            $stmt->bindParam(':descripcion', $descripcion, PDO::PARAM_STR);
            $stmt->bindParam(':id', $id, PDO::PARAM_INT);
            $stmt->execute();
