...
class AcquisitionFormat
{
     ...
     * @param string $name El nombre del formato a buscar (se recomienda pasarlo en minúsculas y sin espacios extra).
     * @return array|false Un array asociativo con los datos del formato, o false si no se encuentra.
     */
    public function getByName(string $name)
    {
        try {
            // Usamos LOWER() y TRIM() para hacer la búsqueda flexible
            $stmt = $this->db->prepare("SELECT id, nombre, descripcion FROM formatos_adquisicion WHERE LOWER(TRIM(nombre)) = :nombre");
